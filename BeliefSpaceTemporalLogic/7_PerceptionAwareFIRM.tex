...
Talk about max log likelihood estimation intuition to find covariance from information matrix...

Talk about degenerate configurations with figures...

Indirectly capture the effect of appearance by weighting this with the number of features...

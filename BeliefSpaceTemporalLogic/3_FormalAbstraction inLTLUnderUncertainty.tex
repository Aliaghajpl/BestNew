...
\begin{align}
	...
	&&P_{k|k}&=f(P_{k-1|k-1})
\end{align}
with $e_k\sim \mathcal N (0, S_k^{-1})$ and  $S_k=\left(CP_{k|k-1}C^T+\mathcal V\right)$. \axx{I dont see e? is e=s?}
...
\axx{interface deserve more explanation and intuition. It is a very key equation/example.}

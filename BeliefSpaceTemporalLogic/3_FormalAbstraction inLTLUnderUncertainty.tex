...
$\word_i \models p   \Equiv p\in\letter_i$, 
    ...
    $\word_i \models \phi_1 \andltl  \phi_2   \Equiv  ( \word_i \models \phi_1 ) \andltl ( \word_i \models \phi_2 ) $, 
    $\word_i \models \phi_1 \orltl  \phi_2   \Equiv  ( \word_i \models \phi_1 ) \orltl ( \word_i \models \phi_2 ) $, 
    $\word_i \models  \phi_1 \Until \phi_2  \Equiv \exists j \geq i \text{ s.t. } (\word_j \models \phi_2 ) $, 
    $  \andltl (\word_k \models \phi_1, \forall k \in \{i, \ldots j-1\})$
    $\word_i \models \Event \phi   \Equiv \exists j \geq i \text{ s.t. }\word_j \models \phi $, and 
    $\word_i \models \Always \phi   \Equiv  \forall j \geq i \text{ s.t. }\word_j \models \phi$.
   % \end{definition}

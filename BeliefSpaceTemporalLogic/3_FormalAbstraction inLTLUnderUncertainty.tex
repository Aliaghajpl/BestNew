...
\new{Next, we show that the  robust policy synthesis, introduced in \cite{tech_report_TACAS}, can used for the new labeling based approximate stochastic simulation relations.}

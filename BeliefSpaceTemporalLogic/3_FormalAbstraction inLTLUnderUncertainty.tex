...
Similarly for propositions on the variance of the current belief state any atomic property which is monotonic in $P$ can be easily mapped to the abstract model.

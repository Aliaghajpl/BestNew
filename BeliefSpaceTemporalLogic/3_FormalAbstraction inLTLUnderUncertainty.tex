...
\begin{definition}[$\delta$-predicate  simulation relation]\label{def:apbsim}
	Consider two gMDPs $\M_i=(\X_i,\pi_i ,\mathbb T_i,\U_i,h_i,\Z),$ $i =1,2$,  over a shared {metric} output space  $(\Z,\mathbf{d}_\Z)$.
	...
	{ \setlength{\parskip}{-2pt}\setlength{\parsep}{-1pt}
		\begin{description}
			...
			\item[\textbf{PS2.}] $\forall (x_1,x_2)\in \rel$, $\forall u_1\in\U_1$:

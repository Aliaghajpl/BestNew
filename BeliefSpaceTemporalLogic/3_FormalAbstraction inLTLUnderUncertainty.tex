...
In this section, we tackle the first research question. That is, we analyze the formulation of distribution temporal logics as originally given in \cite{JonesDTL2013} for POMDPS. 
First, we give the definition of POMDPs. After which we will give a distribution temporal logic.
Given time, it could be a good idea to give the examples of \red{Cristis report}, for the mission planning case study.

...
\section{Belief Space Temporal Logic}
	...
	\subsection{Predicates}\label{sec:DTL}  
     ...
     \begin{prop}[Borel measurability under elementary operations]
  ...
  This is quite intuitive, since for maps on the Euclidean spaces, we also have that the simple algebraic operations are preserve measurability \cite[page 116]{lang1993real}.

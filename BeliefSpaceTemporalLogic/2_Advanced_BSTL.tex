...
\end{problem}
  ...
  More specifically, without loss of generality, we can  assume that the copter can complete its exploration mission before the rover has to start the critical mission. 

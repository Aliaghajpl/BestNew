...
The objective in the mission phase is to maximize the probability that the specification $\varphi$ is satisfied. In addition, to guide the exploration phase it is necessary to quantify the probability of success for different environment belief states at time $T_c$. To this end, the objective of the Mission Problem is to compute for an initial rover state $x^r_{0}$ and for all environment belief states $x^e_{T_c}$ 
\begin{equation}
  \label{eq:mission}

...
\subsection{Markov Decision Processes models}
...
The exploration phase changes the environment belief $x_e$ at time $T_c$. We quantify the effect of the exploration as \emph{mission risk} mission risk $R:\X_{env}\rightarrow [0,1]$ defined as
\begin{equation}
...
We can separate desirable outcomes of the exploration phase into:
\begin{enumerate}

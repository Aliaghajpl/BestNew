...
The sequential Bellman computation is an example of a factored sum-product algorithm \cite{Kschischang2001}, that has previously been used for a similar purpose as ours in the context of MDP abstractions \cite{EsmaeilZadehSoudjani2017}.

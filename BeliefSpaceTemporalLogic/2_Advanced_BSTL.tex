...
\todo[inline]{UNDER CONSTRUCTION}
\todo[inline]{Write that we solve everything with dynamic programming.}
\todo[inline]{Comment on the fact that all the problems will have a finite  end time.}


\subsection{Mission Problem}

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
    ...
    Real-world system on the other had need to be able to operate in continuous environments, while able to reason
	...
	(a) planning a rover with stochastic motion and perception and with partially known maps,
...
% 	}
	...
	The closest work to our own is~\cite{Cristi-CDC-2016}, where the authors a ground vehicle tasks with
	...
	The proposed approach team actively cooperate to achieve the mission, where the rover's planning
	algorithms generates demands for the helicopter explore parts of the environment.

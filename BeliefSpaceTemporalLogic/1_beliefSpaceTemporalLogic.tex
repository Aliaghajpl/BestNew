...
\author{\today}
%\author{Cristian Vasile, Rohan Thakker, Petter Nilsson, Sofie Haesaert, \\ \bf \large Ali Agha, Richard Murray, Aaron Ames\\ \today}
...
\begin{figure*}[t!]
	...
	\subfigure[Visualization of the Mars environment and trajectory executed by the rover at Kimberly region in Gale Crater.]{	
	    \includegraphics[width=0.18\textwidth]{figs/pdf_1.png} ~ \includegraphics[width=0.18\textwidth]{figs/pdf_2.png} ~
...
% 	This paper proposes ... \sofie{[Just remove the section.]}
...
% 	In this work, we assumed the environment map is deterministic. Also, we have assume the copter dynamics are deterministic. We will relax these assumption in the future work.
	...
	\bibliography{references_combined}
